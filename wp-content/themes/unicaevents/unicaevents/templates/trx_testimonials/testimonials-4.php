...
if ( !function_exists( 'unicaevents_template_testimonials_4_theme_setup' ) ) {
	add_action( 'unicaevents_action_before_init_theme', 'unicaevents_template_testimonials_4_theme_setup', 1 );
	function unicaevents_template_testimonials_4_theme_setup() {
		unicaevents_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 4/', 'unicaevents'),
			'thumb_title'  => esc_html__('Avatar (small)', 'unicaevents'),
			'w'		 => 75,
			'h'		 => 75
		));
	}
...
// Template output
if ( !function_exists( 'unicaevents_template_testimonials_4_output' ) ) {
	function unicaevents_template_testimonials_4_output($post_options, $post_data) {
		$show_title = true;
